...
$positions = array('Youth', 'PB', 'CC', 'Women', 'Main');
$pozis = array("Member","Chairman","Secretary","Treasurer","PC","Security","Com Member 1","Com Member 2");
$provinces = array('Harare', 'Bulawayo', 'Mash East', 'Mash Central', 'Mash West', 'Masvingo', 'Midlands', 'Mat North', 'Mat South');
$pozifors = array("None","Province","District","Branch","Cell");
...
$pozi = $result[0]['position'];
$pozifor = $result[0]['position_for'];
            ...
            <div class="tab-content">
                <form class="form" action="includes/edit.php?id=<?php echo $id; ?>" method="POST" id="save_user">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <br>
                            <button type="submit" class="btn btn-lg btn-primary" name="update_user"><i class="fa fa-pencil"></i> Update Member</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-6">
